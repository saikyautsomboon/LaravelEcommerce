    ...
    <main class="main">
        ...
        <div class="container">
            ...
            <div class="owl-carousel mt-5 mb-5 owl-simple" data-toggle="owl" data-owl-options='{
                ...
                <a href="#" class="brand">
                    <img src="{{ asset('lesson1/assets/images/brands/2.png') }}" alt="Brand Name">
                </a>
                ...
                <a href="#" class="brand">
                    <img src="{{ asset('lesson1/assets/images/brands/4.png') }}" alt="Brand Name">
                </a>
                ...
                <a href="#" class="brand">
                    <img src="{{ asset('lesson1/assets/images/brands/6.png') }}" alt="Brand Name">
                </a>
            </div>
            <!-- End .owl-carousel -->
        </div>
                                ...
                                <div class="owl-carousel owl-full carousel-equal-height carousel-with-shadow"
                                    ...
                                    <div class="product product-2">
                                        <figure class="product-media">
                                            <span class="product-label label-circle label-top">Top</span>
                                            <a href="product.html">
                                                <img src="{{ asset('lesson1/assets/images/demos/demo-4/products/product-6.jpg') }}"
                                                    alt="Product image" class="product-image">
                                            </a>
                                    ...
                                    <div class="product product-2">
                                        <figure class="product-media">
                                            <a href="product.html">
                                                <img src="{{ asset('lesson1/assets/images/demos/demo-4/products/product-7.jpg') }}"
                                                    alt="Product image" class="product-image">
                                            </a>
                                    ...
                                    <div class="product product-2">
                                        <figure class="product-media">
                                            ...
                                            <span class="product-label label-circle label-sale">Sale</span>
                                            <a href="product.html">
                                                <img src="{{ asset('lesson1/assets/images/demos/demo-4/products/product-9.jpg') }}"
                                                    alt="Product image" class="product-image">
                                            </a>
                                        ...
                                        <div class="product-body">
                                            ...
                                            <!-- End .product-cat -->
                                            <h3 class="product-title"><a href="product.html">Sony - Class LED 2160p Smart
                                                    4K Ultra HD</a></h3>
                                            <!-- End .product-title -->
                                            <div class="product-price">
